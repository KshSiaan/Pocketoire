...
export function CookieConsent({
  ...
  const [{ historyConsent }, setCookie, removeCookie] = useCookies([
    "historyConsent",
  ]);
  ...
  const accept = () => {
    ...
    // ✅ set via react-cookie
    setCookie("historyConsent", true, {
      path: "/",
  ...
  const decline = () => {
    ...
    // optional: explicitly store decline
    setCookie("historyConsent", false, {
      path: "/",
      expires: new Date("9999-12-31"),
    });
